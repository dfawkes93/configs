...
return { -- Right widgets
            ...
            wibox.container.background(mysep(theme.color_3, right_tri), theme.color_4),
			wibox.container.background(wifiwidget, theme.color_3),
            wibox.container.background(mysep(theme.color_5, right_tri), theme.color_3),
